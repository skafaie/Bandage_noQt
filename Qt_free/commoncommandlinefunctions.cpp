...
{
    return count(arguments.begin(), arguments.end(), option) ;
}
...
void checkOptionWithoutValue(string option, vector<string>& arguments)
{
    ...
    it = find(arguments.begin(), arguments.end(), option);
    ...
    {
        // calculating the index of option
        arguments.erase(it);
...
string checkForInvalidOrExcessSettings(vector<string>& arguments)
{
    ...
    vector<string> argumentsCopy(arguments);

    vector<string> validScopeOptions;
    validScopeOptions.push_back("entire");
    validScopeOptions.push_back("aroundnodes");
    validScopeOptions.push_back("aroundblast");
    validScopeOptions.push_back("depthrange");
    ...
    error = checkOptionForString("--nodes", arguments, temp, "a list of node names"); if (error.length() > 0) return error;
    ...
    error = checkOptionForString("--blastp", arguments, temp, "blastn/tblastn parameters"); if (error.length() > 0) return error;
   ...
   error = checkOptionForSciNot("--evfilter", arguments, g_settings->blastEValueFilter, false); if (error.length() > 0) return error;
    ...
    {
        string optionString = getStringOption("--minpatlen", argumentsCopy);
        if (iequals(optionString, "off"))
    ...
    {
        string optionString = getStringOption("--maxpatlen", argumentsCopy);
        if (iequals(optionString, "off"))
    ...
    {
        string optionString = getStringOption("--minlendis", argumentsCopy);
        if (iequals(optionString, "off"))
    ...
    {
        string optionString = getStringOption("--maxlendis", argumentsCopy);
        if (iequals(optionString, "off"))
...
string checkOptionForString(string option, vector<string>& arguments, vector<string> validOptionsList, string validDescription)
{
    int optionIndex = -1;
    vector<string>::iterator it;
    it = find(arguments.begin(), arguments.end(), option);
    ...
    {
        // calculating the index of option
        int optionIndex = it - arguments.begin();
    }
    ...
    {
        bool found = false;
        string value = arguments.at(stringIndex);
        for (int i = 0; i < validOptionsList.size(); i++) {
            if (iequals(validOptionsList.at(i), value)) {
                found = true;
                break;
            }
        }
    ...
    arguments.erase(arguments.begin() + stringIndex);
    arguments.erase(arguments.begin() + optionIndex);
...
{
    //find the index of option in arguments
    int optionIndex = -1;
    vector<string>::iterator it;
    it = find(arguments.begin(), arguments.end(), option);
    //If the option isn't found, that's fine.
    ...
    bool optionIsInt = isNumber(arguments.at(integerIndex));
    int optionInt = 0;
    if (optionIsInt)
        optionInt = std::stoi(arguments.at(integerIndex));
    //int optionInt = arguments.at(integerIndex).toInt(&optionIsInt);
    bool optionIsOff = iequals(arguments.at(integerIndex), "off");
    ...
    if (optionIsInt)
    {
        if (optionInt < setting.min || optionInt > setting.max)
            return "Value of " + option + " must be between "
                    + to_string(setting.min) + " and " + to_string(setting.max) +
                    " (inclusive)";
    }
    ...
    arguments.erase(arguments.begin() + integerIndex);
    arguments.erase(arguments.begin() + optionIndex);
...
string checkOptionForFloat(string option, vector<string>& arguments, FloatSetting setting, bool offOkay)
{
    ...
    double optionFloat = 0;
    bool optionIsFloat = isFloat(arguments.at(floatIndex));
    if (optionIsFloat)
        optionFloat = std::stod(arguments.at(floatIndex));
        
    bool optionIsOff = iequals(arguments.at(floatIndex), "off");
    ...
    //arguments->removeAt(optionIndex);
    arguments.erase(arguments.begin() + floatIndex);
    arguments.erase(arguments.begin() + optionIndex);
...
string checkOptionForFile(string option, vector<string>& arguments)
{
    ...
    //arguments->removeAt(optionIndex);
    arguments.erase(arguments.begin() + fileIndex);
    arguments.erase(arguments.begin() + optionIndex);
...
//problem.  If everything is okay, it also removes the option and its value from
//arguments.
string checkOptionForSciNot(string option, vector<string>& arguments,
                             SciNotSetting setting, bool offOkay)
{
    ...
    bool optionIsOff = iequals(arguments.at(sciNotIndex) , "off");
    ...
    //arguments->removeAt(optionIndex);
    arguments.erase(arguments.begin() + sciNotIndex);
    arguments.erase(arguments.begin() + optionIndex);
...
double getFloatOption(string option, vector<string>& arguments)
{
    ...
    else
    {
     ...
     return std::stod(arguments.at(floatIndex));
}
...
int getIntOption(string option, vector<string>& arguments)
{
    ...
    return std::stoi(arguments.at(integerIndex));
}
...
bool isOptionAndValuePresent(string option, string value, vector<string>& arguments)
{
    int optionIndex = -1;
    vector<string>::iterator it;
    it = find(arguments.begin(), arguments.end(), option);
    ...
    string optionValue = arguments.at(valueIndex);
...
string checkForExcessArguments(vector<string>& arguments)
{
    ...
    string invalidOptionText = "Invalid option";
    if (arguments.size() > 1)
        invalidOptionText += "s";
    invalidOptionText += ": ";
...
void parseSettings(vector<string> arguments)
{
    ...
    {
        string optionString = getStringOption("--minhitcov", arguments);
        if (iequals(optionString, "off"))
    ...
    {
        string optionString = getStringOption("--minmeanid", arguments);
        if (iequals(optionString, "off"))
    ...
    {
        string optionString = getStringOption("--maxevprod", arguments);
        if (iequals(optionString, "off"))
    ...
    {
        string optionString = getStringOption("--minpatlen", arguments);
        if (iequals(optionString, "off"))
    ...
    {
        string optionString = getStringOption("--maxpatlen", arguments);
        if (iequals(optionString, "off"))
    ...
    {
        string optionString = getStringOption("--minlendis", arguments);
        if (iequals(optionString, "off"))
    ...
    {
        string optionString = getStringOption("--maxlendis", arguments);
        if (iequals(optionString, "off"))
            g_settings->maxLengthBaseDiscrepancy.on = false;
        else
        {
